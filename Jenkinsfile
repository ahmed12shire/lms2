    ...
    stages {
        ...
        stage('Sonar Analysis') {
            steps {
                ...
                sh 'sudo docker run --rm -e SONAR_HOST_URL="http://3.99.221.240:9000" -e SONAR_TOKEN="sqp_0135bba75840ab307f31a1e480e7f211c25f8f37" -v ".:/usr/src" sonarsource/sonar-scanner-cli -Dsonar.projectKey=lms'
